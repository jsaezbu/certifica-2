...
CONTRACT_ADDRESS="erd1qqqqqqqqqqqqqpgqnqedff8xd00lr8p56fammwftypdh5d85md8qeu72h0" # Dirección real del smart contract
PEM_PATH="$HOME/wallet2.pem" # Ruta al archivo PEM de la wallet del emisor
